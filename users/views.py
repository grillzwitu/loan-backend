...
class LogoutView(APIView):
    """
    Endpoint for logging out authenticated users by instructing client to discard the JWT.
    """
    permission_classes = (IsAuthenticated,)

    def post(self, request: Request) -> Response:
        """
        Handle POST request to log out by instructing client to discard the JWT.
